...
class OpenAIClient
{
    ...
    /**
     * Sube un archivo PDF a /v1/files para referenciarlo después.
     */
    ...
    /**
     * Crea un nuevo Thread con mensajes iniciales.
     * @deprecated Usar callResponses con el endpoint /v1/responses.
     */
    ...
    /**
     * Crea un Run en un Thread.
     * @deprecated Usar callResponses con el endpoint /v1/responses.
     */
    public function createRun(string $threadId, string $assistantId, string $model = 'gpt-4o-mini'): array
    {
        $payload = [
    ...
    /**
     * Crea un Assistant dinámicamente.
     * @deprecated Usar callResponses con el endpoint /v1/responses.
     */
